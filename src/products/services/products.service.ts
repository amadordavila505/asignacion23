...
export class ProductService {
    ...
    async update( id: number ,cambios: CreateProductDto) {
        ...
        // empezemos a correr nuestro queryRunner, esto seria el punto de partida de nuestra trasaccion
        const queryRunner = this.dataSource.createQueryRunner();
        await queryRunner.connect();
        await queryRunner.startTransaction();
        
        if (images) {
            //si images no esta vacio, vamos a borrar las imagenes existente
            ...
            this.productImageRepo.create({url: image}),
                ...
                product.images = await this. productImageRepo.findBy({ product: { id }});
                 ...
                 //Finalizamos la transacion y liberamos el queryRunner
